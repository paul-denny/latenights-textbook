...
Or, if we know that the iterable or sequence contains several repeated values we are likely to search for, the performance improves even more – depending on how many times values are repeated.
