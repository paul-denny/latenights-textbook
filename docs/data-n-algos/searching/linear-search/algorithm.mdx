...
In this case, we can adapt our linear search algorithm to return the first index of a value in a sequence.
For example:
...
<CodeBlock title={'Finding the Last Index - The next Function'}
           code={`
...
<Feedback page={'linear-search/searching'}/>
