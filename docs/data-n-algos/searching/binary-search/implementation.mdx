...
Python already has a module for performing binary search – the <u>[`bisect`](https://docs.python.org/3/library/bisect.html)</u> module.
...
The <u>[`bisect_left`](https://docs.python.org/3/library/bisect.html#bisect.bisect_left)</u> function takes a sequence and a target value as parameters and returns the first index in the sequence where inserting the target value would maintain sorted order using binary search in the background.
...
There are additional examples of variations of this <u>[in the Python docs](https://docs.python.org/3/library/bisect.html#searching-sorted-lists)</u>.
